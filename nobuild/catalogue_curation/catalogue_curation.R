...
filter_cosmic_catalogue = function(catalogue) {
  rm_sigs = list(
  ...
  catalogue_filt["SBS5",] = catalogue["SBS5",]
...
COSMIC_filt_merged = filter_cosmic_catalogue(COSMIC_merged)
...
COSMIC_filt = filter_cosmic_catalogue(COSMIC_catalogue)
