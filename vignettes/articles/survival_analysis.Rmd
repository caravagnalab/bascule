...
we defined a function called `sync_metadata` which gets bascule object and coresponding clinical mnetadata as input and orchestrate and merge those files and based on the patients IDs.
